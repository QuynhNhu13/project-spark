...
const FinanceLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-muted/30 overflow-hidden">
      <aside className={cn("bg-[hsl(160,40%,18%)] flex flex-col shrink-0 transition-all duration-300", collapsed ? "w-[72px]" : "w-[260px]")}>
        <div className="h-16 flex items-center gap-3 px-4 border-b border-white/10">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-white/60 leading-tight">Kế toán</p>
            </div>
          )}
